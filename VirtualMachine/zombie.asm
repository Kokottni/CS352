...
0000000000000362 <getschedhistory>:
...
malloc(uint nbytes)
{
 ...
 740:	0e453503          	ld	a0,228(a0) # 820 <freep>
 ...
 774:	0b878793          	addi	a5,a5,184 # 828 <base>
 778:	00000717          	auipc	a4,0x0
 77c:	0af73423          	sd	a5,168(a4) # 820 <freep>
 780:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7a2:	08a73123          	sd	a0,130(a4) # 820 <freep>
      return (void*)(p + 1);
