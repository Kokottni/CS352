...
0000000000000610 <getschedhistory>:
...
free(void *ap)
{
 ...
 94c:	1f87b783          	ld	a5,504(a5) # b40 <freep>
 ...
 97a:	00e6ea63          	bltu	a3,a4,98e <free+0x50>
{
 ...
 9bc:	18f73423          	sd	a5,392(a4) # b40 <freep>
}
 9c0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9ee:	15653503          	ld	a0,342(a0) # b40 <freep>
 ...
 a16:	12e90913          	addi	s2,s2,302 # b40 <freep>
  if(p == (char*)-1)
 a1a:	5afd                	li	s5,-1
 a1c:	a88d                	j	a8e <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 a1e:	00000797          	auipc	a5,0x0
 a22:	13a78793          	addi	a5,a5,314 # b58 <base>
 a26:	00000717          	auipc	a4,0x0
 a2a:	10f73d23          	sd	a5,282(a4) # b40 <freep>
 a2e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a50:	0ea73a23          	sd	a0,244(a4) # b40 <freep>
      return (void*)(p + 1);
