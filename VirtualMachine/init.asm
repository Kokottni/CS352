...
0000000000000430 <getschedhistory>:
...
free(void *ap)
{
 ...
 76c:	2107b783          	ld	a5,528(a5) # 978 <freep>
 ...
 79a:	00e6ea63          	bltu	a3,a4,7ae <free+0x50>
{
 ...
 7dc:	1af73023          	sd	a5,416(a4) # 978 <freep>
}
 7e0:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 80e:	16e53503          	ld	a0,366(a0) # 978 <freep>
 ...
 836:	14690913          	addi	s2,s2,326 # 978 <freep>
  if(p == (char*)-1)
 83a:	5afd                	li	s5,-1
 83c:	a88d                	j	8ae <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 83e:	00000797          	auipc	a5,0x0
 842:	14278793          	addi	a5,a5,322 # 980 <base>
 846:	00000717          	auipc	a4,0x0
 84a:	12f73923          	sd	a5,306(a4) # 978 <freep>
 84e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 870:	10a73623          	sd	a0,268(a4) # 978 <freep>
      return (void*)(p + 1);
