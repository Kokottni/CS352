...
main(int argc, char **argv)
{
  ...
  4c:	7f058593          	addi	a1,a1,2032 # 838 <malloc+0xe6>
  50:	4509                	li	a0,2
...
000000000000039c <getschedhistory>:
...
free(void *ap)
{
 ...
 6d8:	19c7b783          	ld	a5,412(a5) # 870 <freep>
 ...
 706:	00e6ea63          	bltu	a3,a4,71a <free+0x50>
{
 ...
 748:	12f73623          	sd	a5,300(a4) # 870 <freep>
}
 74c:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 77a:	0fa53503          	ld	a0,250(a0) # 870 <freep>
 ...
 7a2:	0d290913          	addi	s2,s2,210 # 870 <freep>
  if(p == (char*)-1)
 7a6:	5afd                	li	s5,-1
 7a8:	a88d                	j	81a <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7aa:	00000797          	auipc	a5,0x0
 7ae:	0ce78793          	addi	a5,a5,206 # 878 <base>
 7b2:	00000717          	auipc	a4,0x0
 7b6:	0af73f23          	sd	a5,190(a4) # 870 <freep>
 7ba:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7dc:	08a73c23          	sd	a0,152(a4) # 870 <freep>
      return (void*)(p + 1);
