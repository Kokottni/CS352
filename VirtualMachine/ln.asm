...
0000000000000398 <getschedhistory>:
...
malloc(uint nbytes)
{
 ...
 776:	11653503          	ld	a0,278(a0) # 888 <freep>
 ...
 7b2:	0cf73d23          	sd	a5,218(a4) # 888 <freep>
 7b6:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
