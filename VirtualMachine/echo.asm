...
00000000000003bc <getschedhistory>:
...
malloc(uint nbytes)
{
 ...
 79a:	0f253503          	ld	a0,242(a0) # 888 <freep>
 ...
 7ce:	0c678793          	addi	a5,a5,198 # 890 <base>
 7d2:	00000717          	auipc	a4,0x0
 7d6:	0af73b23          	sd	a5,182(a4) # 888 <freep>
 7da:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7fc:	08a73823          	sd	a0,144(a4) # 888 <freep>
      return (void*)(p + 1);
