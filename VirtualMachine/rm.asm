...
00000000000003b0 <getschedhistory>:
...
malloc(uint nbytes)
{
 ...
 78e:	11e53503          	ld	a0,286(a0) # 8a8 <freep>
 ...
 7c2:	0f278793          	addi	a5,a5,242 # 8b0 <base>
 7c6:	00000717          	auipc	a4,0x0
 7ca:	0ef73123          	sd	a5,226(a4) # 8a8 <freep>
 7ce:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7f0:	0aa73e23          	sd	a0,188(a4) # 8a8 <freep>
      return (void*)(p + 1);
