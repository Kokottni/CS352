...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	31658593          	addi	a1,a1,790 # 1328 <malloc+0xe4>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	2d058593          	addi	a1,a1,720 # 1330 <malloc+0xec>
      68:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	29e50513          	addi	a0,a0,670 # 1338 <malloc+0xf4>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	37270713          	addi	a4,a4,882 # 1438 <malloc+0x1f4>
    ...
    panic("runcmd");
      ...
      e4:	26050513          	addi	a0,a0,608 # 1340 <malloc+0xfc>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	24658593          	addi	a1,a1,582 # 1348 <malloc+0x104>
     10a:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     152:	20a58593          	addi	a1,a1,522 # 1358 <malloc+0x114>
     156:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     1e8:	18450513          	addi	a0,a0,388 # 1368 <malloc+0x124>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     400:	09498993          	addi	s3,s3,148 # 1490 <whitespace>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     464:	03098993          	addi	s3,s3,48 # 1490 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4ce:	fc698993          	addi	s3,s3,-58 # 1490 <whitespace>
     4d2:	00001a97          	auipc	s5,0x1
     4d6:	fb6a8a93          	addi	s5,s5,-74 # 1488 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     538:	f5c98993          	addi	s3,s3,-164 # 1490 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a8:	decb8b93          	addi	s7,s7,-532 # 1390 <malloc+0x14c>
  ...
  while(peek(ps, es, "<>")){
     ...
     5ba:	dba50513          	addi	a0,a0,-582 # 1370 <malloc+0x12c>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a2:	cfa60613          	addi	a2,a2,-774 # 1398 <malloc+0x154>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d2:	ceab0b13          	addi	s6,s6,-790 # 13b8 <malloc+0x174>
  ...
  return ret;
     ...
     70c:	c9850513          	addi	a0,a0,-872 # 13a0 <malloc+0x15c>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76e:	c3e50513          	addi	a0,a0,-962 # 13a8 <malloc+0x164>
...
0000000000000788 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a8:	c1c60613          	addi	a2,a2,-996 # 13c0 <malloc+0x17c>
     7ac:	85ce                	mv	a1,s3
     7ae:	854a                	mv	a0,s2
...
00000000000007f6 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     818:	bb4a0a13          	addi	s4,s4,-1100 # 13c8 <malloc+0x184>
  ...
  if(peek(ps, es, ";")){
     ...
     84e:	b8660613          	addi	a2,a2,-1146 # 13d0 <malloc+0x18c>
     852:	85ce                	mv	a1,s3
     854:	854a                	mv	a0,s2
...
000000000000089e <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b4:	ae860613          	addi	a2,a2,-1304 # 1398 <malloc+0x154>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e4:	b0860613          	addi	a2,a2,-1272 # 13e8 <malloc+0x1a4>
     8e8:	85ca                	mv	a1,s2
     8ea:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     926:	ab650513          	addi	a0,a0,-1354 # 13d8 <malloc+0x194>
     92a:	fffff097          	auipc	ra,0xfffff
     92e:	72c080e7          	jalr	1836(ra) # 56 <panic>
    panic("syntax - missing )");
     932:	00001517          	auipc	a0,0x1
     936:	abe50513          	addi	a0,a0,-1346 # 13f0 <malloc+0x1ac>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     962:	af270713          	addi	a4,a4,-1294 # 1450 <malloc+0x20c>
...
00000000000009da <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0e:	9fe60613          	addi	a2,a2,-1538 # 1408 <malloc+0x1c4>
     a12:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a44:	9d058593          	addi	a1,a1,-1584 # 1410 <malloc+0x1cc>
     a48:	4509                	li	a0,2
     a4a:	00000097          	auipc	ra,0x0
     a4e:	70e080e7          	jalr	1806(ra) # 1158 <fprintf>
    panic("syntax");
     a52:	00001517          	auipc	a0,0x1
     a56:	94e50513          	addi	a0,a0,-1714 # 13a0 <malloc+0x15c>
...
0000000000000a62 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a78:	9ac48493          	addi	s1,s1,-1620 # 1420 <malloc+0x1dc>
     a7c:	4589                	li	a1,2
     a7e:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     a9e:	a0648493          	addi	s1,s1,-1530 # 14a0 <buf.0>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa2:	06300913          	li	s2,99
     aa6:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aaa:	00001a17          	auipc	s4,0x1
     aae:	9f9a0a13          	addi	s4,s4,-1543 # 14a3 <buf.0+0x3>
        fprintf(2, "cannot cd %s\n", buf+3);
     ab2:	00001a97          	auipc	s5,0x1
     ab6:	976a8a93          	addi	s5,s5,-1674 # 1428 <malloc+0x1e4>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b38:	96c50513          	addi	a0,a0,-1684 # 14a0 <buf.0>
...
0000000000000e8e <getschedhistory>:
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     ec4:	f3e080e7          	jalr	-194(ra) # dfe <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ef6:	57e50513          	addi	a0,a0,1406 # 1470 <digits>
     efa:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     fc2:	4b2b8b93          	addi	s7,s7,1202 # 1470 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1102:	36a90913          	addi	s2,s2,874 # 1468 <malloc+0x224>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    11ca:	2d27b783          	ld	a5,722(a5) # 1498 <freep>
    ...
    11f8:	00e6ea63          	bltu	a3,a4,120c <free+0x50>
{
  ...
  freep = p;
    1236:	00000717          	auipc	a4,0x0
    123a:	26f73123          	sd	a5,610(a4) # 1498 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1268:	00000517          	auipc	a0,0x0
    126c:	23053503          	ld	a0,560(a0) # 1498 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    1290:	00000917          	auipc	s2,0x0
    1294:	20890913          	addi	s2,s2,520 # 1498 <freep>
  if(p == (char*)-1)
    1298:	5afd                	li	s5,-1
    129a:	a88d                	j	130c <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    129c:	00000797          	auipc	a5,0x0
    12a0:	26c78793          	addi	a5,a5,620 # 1508 <base>
    12a4:	00000717          	auipc	a4,0x0
    12a8:	1ef73a23          	sd	a5,500(a4) # 1498 <freep>
    ...
    12ce:	1ca73723          	sd	a0,462(a4) # 1498 <freep>
      return (void*)(p + 1);
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    131c:	b4e080e7          	jalr	-1202(ra) # e66 <sbrk>
  if(p == (char*)-1)
