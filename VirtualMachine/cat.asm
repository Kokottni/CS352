...
0000000000000456 <getschedhistory>:
...
putc(int fd, char c)
{
 ...
 48c:	f3e080e7          	jalr	-194(ra) # 3c6 <write>
}
...
free(void *ap)
{
 ...
 792:	1ca7b783          	ld	a5,458(a5) # 958 <freep>
 ...
 7c0:	00e6ea63          	bltu	a3,a4,7d4 <free+0x50>
{
 ...
 802:	14f73d23          	sd	a5,346(a4) # 958 <freep>
}
 806:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 834:	12853503          	ld	a0,296(a0) # 958 <freep>
 ...
 85c:	10090913          	addi	s2,s2,256 # 958 <freep>
  if(p == (char*)-1)
 860:	5afd                	li	s5,-1
 862:	a88d                	j	8d4 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 864:	00000797          	auipc	a5,0x0
 868:	2fc78793          	addi	a5,a5,764 # b60 <base>
 86c:	00000717          	auipc	a4,0x0
 870:	0ef73623          	sd	a5,236(a4) # 958 <freep>
 874:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 896:	0ca73323          	sd	a0,198(a4) # 958 <freep>
      return (void*)(p + 1);
 ...
 8e4:	b4e080e7          	jalr	-1202(ra) # 42e <sbrk>
  if(p == (char*)-1)
