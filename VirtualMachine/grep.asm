...
000000000000011a <grep>:
{
 ...
 13e:	996a8a93          	addi	s5,s5,-1642 # ad0 <buf>
...
00000000000005d6 <getschedhistory>:
...
free(void *ap)
{
 ...
 912:	1ba7b783          	ld	a5,442(a5) # ac8 <freep>
 ...
 940:	00e6ea63          	bltu	a3,a4,954 <free+0x50>
{
 ...
 982:	14f73523          	sd	a5,330(a4) # ac8 <freep>
}
 986:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9b4:	11853503          	ld	a0,280(a0) # ac8 <freep>
 ...
 9dc:	0f090913          	addi	s2,s2,240 # ac8 <freep>
  if(p == (char*)-1)
 9e0:	5afd                	li	s5,-1
 9e2:	a88d                	j	a54 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 9e4:	00000797          	auipc	a5,0x0
 9e8:	4ec78793          	addi	a5,a5,1260 # ed0 <base>
 9ec:	00000717          	auipc	a4,0x0
 9f0:	0cf73e23          	sd	a5,220(a4) # ac8 <freep>
 9f4:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a16:	0aa73b23          	sd	a0,182(a4) # ac8 <freep>
      return (void*)(p + 1);
